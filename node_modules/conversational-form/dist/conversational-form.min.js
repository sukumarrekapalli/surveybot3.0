                    ...
                    for (var r = 0; r < n.length; r++) {
                        ...
                        if ("" !== l && "cf-conditional-" + l === a.key.toLowerCase()) {
                            var c = (s.value, s.value),
                                h = t.Tag.testConditions(c, a);
                            if (h && (this.activeConditions[l] = n, ++i == n.length)) return !0
                        }
                    }
            }
            return !1
...
! function(t) {
    var e = function() {
        ...
        return Object.defineProperty(e.prototype, "createId", {
            ...
            switch (this.theme) {
                case "dark":
                    this.theme = "conversational-form-dark.min.css", this.options.robotImage || this.updateDictionaryValue("robot-image", "robot", "./kiava.png"), this.options.userImage || this.updateDictionaryValue("user-image", "user", "./kiava.png");
                    break;
                case "green":
                    ...
                    break;
                case "blue":
                    this.theme = "conversational-form-irisblue.min.css", this.options.robotImage || this.updateDictionaryValue("robot-image", "robot", "./kiava.png"), this.options.userImage || this.updateDictionaryValue("user-image", "user", "data:image/svg+xml,%3Csvg width='200' height='200' viewBox='0 0 200 200' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Ccircle cx='100' cy='100' r='100' fill='%2300C2DF'/%3E%3Cpath d='M100 55L138.971 122.5H61.0289L100 55Z' fill='%23E8E9EB'/%3E%3C/svg%3E%0A");
                    break;
                case "purple":
                ...
                if ("fieldset" === r.tag)
                    for (var a = t.TagsParser.parseGroupTag(r), l = 0; l < a.children.length; l++) {
                        ...
                        if (t.Tag.isTagValid(c)) {
                            ...
                            h.name || (h.name = "tag-ref-" + l.toString()), o.push(h)
                        }
                    } else {
